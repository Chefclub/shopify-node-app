...
const shopifyConfig = {
  ...
  scope: ['write_fulfillments, read_fulfillments,read_shipping,read_all_orders,write_shipping,read_customers,write_customers,read_orders,write_orders,write_products'],
